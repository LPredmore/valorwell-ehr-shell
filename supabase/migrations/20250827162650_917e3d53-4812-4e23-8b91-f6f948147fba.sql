...
-- Fix the handle_new_user trigger function to properly handle array-type role column
...
BEGIN
  ...
  -- Insert into profiles table with array-type role
  BEGIN
    INSERT INTO public.profiles (
      ...
      NEW.id,
      NEW.email,
      ARRAY[user_role::public.user_role],
      user_password,
      NOW(),
      NOW()
